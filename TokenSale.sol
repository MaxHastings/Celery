...
contract TokenSale {
    ...
    function BuyTokens(uint256 numberOfTokens) public payable {
        ...
        require(msg.value == (numberOfTokens * TokenPrice), "Your BCH and Celery ratio amounts must match per the price");
    
        uint256 scaledAmount = numberOfTokens * (uint256(10) ** TokenContract.decimals());
    
        require(TokenContract.balanceOf(address(this)) >= scaledAmount, "Token sale contract does not have enough Celery");
